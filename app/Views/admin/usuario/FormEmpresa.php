            ...
            <div class="col-md-12">
                <div class="card card-<?php echo $color; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" id="usuaruiID" value="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input onkeypress="return soloLetras(event)" autocomplete="off" value="" type="text" name="nombres" class="form-control" id="nombres" placeholder="Ingres nombres" maxlength="80">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input onkeypress="return soloLetras(event)" autocomplete="off" value="" type="text" name="apellidos" class="form-control" id="apellidos" placeholder="Ingrese apellidos" maxlength="80">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" value="" type="text" name="correo" class="form-control" id="correo" placeholder="Ingrese correo" maxlength="80">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input onkeypress="return soloNumeros(event)" autocomplete="off" value="" type="text" name="cedula" class="form-control" id="cedula" placeholder="Ingrese cedula" maxlength="10">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" value="" type="text" name="usuario" class="form-control" id="usuario" placeholder="Ingrese usuario" maxlength="50">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" value="" type="password" name="password" class="form-control" id="password" placeholder="Ingrese password" maxlength="20">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" value="" type="password" name="confirm_password" class="form-control" id="confirm_password" placeholder="Confirmar Password" maxlength="20">
                                </div>
                            </div>
