         ...
         <div class="row mb-2">
             ...
             <div class="col-sm-6">
                 <ol class="breadcrumb float-sm-right">
                     ...
                     <li class="breadcrumb-item active">Lista producción</li>
                 </ol>
             </div>
         </div>
     </div>
             ...
             <div class="row">
                 ...
                 <div class="col-6 col-sm-6 col-md-6 d-flex align-items-stretch flex-column">
                     <div class="col-12 col-sm-6 col-md-12 d-flex align-items-stretch flex-column">
                         <input autocomplete="off" value="" type="text" class="form-control" id="buscarproduccion" placeholder="Buscar producción..." maxlength="35">
                     </div>
                 </div>
