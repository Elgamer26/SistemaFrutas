                ...
                <div class="card card-<?php echo $color; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="sexo">Sexo</label> <span id="sexo_olbligg" value="<?php echo $editar[7]; ?>" style="color: red;"></span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" value="<?php echo $editar[6]; ?>" type="text" name="direccion" class="form-control" id="direccion" placeholder="Ingrese direccion" maxlength="100">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input onkeypress="return soloNumeros(event)" autocomplete="off" value="<?php echo $editar[7]; ?>" type="text" name="telefono" class="form-control" id="telefono" placeholder="Ingrese telefono" maxlength="10">
                                </div>
                            </div>

                            <input type="hidden" id="estaddoListado" value="<?php echo $btn; ?>">
                    ...
                    <div class="card-footer">
                        ...
                        <?php if($btn != "") { ?>
                        <a onclick="cargar_contenido('contenido_principal','<?php echo base_url(); ?>admin/ListadoCliente/<?php echo $btn; ?>');" class='btn btn-danger'>Volver</a>
                        <?php } ?>
