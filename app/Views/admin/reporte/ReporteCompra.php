...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1> Reporte compra insumo <i class="fa fa-file"></i> </h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin">Inicio</a></li>
                    <li class="breadcrumb-item active">Reporte compra insumo</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><b>Reporte de compra insumo</b></h3>
                    </div>
...
<script>
    function VerReporteVneta() {
        ...
        ifrm.setAttribute("src", "<?php echo base_url(); ?>Reporte/reportecompraModulo/" + fecha_inicio + "/" + fecha_fin + "");
    ...
    function VerReporteVnetaTodo() {
        ...
        var ifrm = document.getElementById("iframe_compra");
        ifrm.setAttribute("src", "<?php echo base_url(); ?>Reporte/reportecompraModuloTodo/");
