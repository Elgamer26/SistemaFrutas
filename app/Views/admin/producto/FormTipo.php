        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="#" onclick="cargar_contenido('contenido_principal','<?php echo base_url(); ?>admin/tipoProducto/list/0');">Listado Tipo</a></li>
                ...
                <div class="card card-<?php echo $color; ?>">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="nombreTipo">Nombre del Tipo</label> <span id="TipoProducto_olbligg" style="color: red;"></span>
                    ...
                    <div class="card-footer">
                        <?php echo $accion; ?> - <a onclick="cargar_contenido('contenido_principal','<?php echo base_url(); ?>admin/tipoProducto/list/0');" class='btn btn-danger'>Volver</a>
                    </div>
