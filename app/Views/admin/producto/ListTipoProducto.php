                                                    ...
                                                    <tr class="odd">
                                                        <td>
                                                            <?php if ($ListadoTipo_item["estado"] == "1") {     ?>
                                                                ...
                                                                <a onclick="cargar_contenido('contenido_principal','<?php echo base_url(); ?>admin/tipoProducto/edit/<?php echo $ListadoTipo_item['id']; ?>');" class='editar btn btn-primary btn-sm' title='Editar el Tipo'><i class='fa fa-edit'></i></a>
                                                            <?php   } else {     ?>
                                                                ...
                                                                <a onclick="cargar_contenido('contenido_principal','<?php echo base_url(); ?>admin/tipoProducto/edit/<?php echo $ListadoTipo_item['id']; ?>');" class='editar btn btn-primary btn-sm' title='Editar el Tipo'><i class='fa fa-edit'></i></button>
                                                                <?php   } ?>
                                                        </td>
